...
- Understanding the differences between the 2 implementations should be helpful for understanding the relationship of [cw721](https://crates.io/crates/cw721) to [cw721-base](https://crates.io/crates/cw721-base), and the relationship of [cw721](https://crates.io/crates/cw721) and [cw721-base](https://crates.io/crates/cw721-base) to your own custom NFT projects.
