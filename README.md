...
- Either 1) Import everything locally so that [cw721](https://crates.io/crates/cw721-base)'s internals can be modified directly (e.g. "Contractor" implementation); or, 2) import cw721 into a separate project and expose it as a library (e.g. "Librarian" implementation)
